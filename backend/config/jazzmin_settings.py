JAZZMIN_SETTINGS = {
    #title
    "site_title": "R Product bd : Here admin or staff can manage admin panel",
    "site_header": "R Product",
    "site_brand": "R Product bd",
    ...
    "welcome_sign": "Welcome to the R Product bd",

    #Footer
    "copyright": "by R Product | Kushghop Software",
